...
const ADMIN_SHARD = preload("res://Entities/Weapons/Staffs/Admin Staff/admin_attacks/Primary/admin_shard.tscn")
const ADMIN_SHIELD = preload("res://Entities/Weapons/Staffs/Admin Staff/admin_attacks/Secondary/admin_shield.tscn")
...
func shoot_primary() -> void:
	var bone_shard = ADMIN_SHARD.instantiate()
	var dir: Vector2
...
func shoot_secondary() -> void:
	...
	for i in bone_amount:
		var temp_bone_shield = ADMIN_SHIELD.instantiate()
